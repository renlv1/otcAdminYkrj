            ...
            <div class="main-content">
                ...
                <div class="quill-editor">
                    ...
                    <div class="editor">
                        ...
                        <div class="textNumber">{{textNum}} / 100</div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail () {
        this.$fetch.post(`system/notice/preNoticeDetail?id=${this.noticeId}`).then((res) => {
          if (res.msg === '成功') {
            let detail = res.data.notice
            this.id = detail.id
      ...
      onEditorChange(event){
        event.quill.deleteText(100, 4)// 编辑文字在100字以内
        if(this.content === ''){
          this.textNum = 0
        } else {
