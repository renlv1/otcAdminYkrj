        ...
        <div class="web-table">
          <div class="center">
            <div class="common-thead">
              ...
              <div class="thead">获取奖励值</div>
              <div class="thead">获取优惠权值</div>
            ...
            <div v-for="(item, index) in isListNull(list)" :key="index" class="tbody-wrap">
              <div class=" common-tbody">
                ...
                <div class="tbody">{{item.rewardTotal}}</div>
                <div class="tbody">{{item.discount}}</div>
              ...
              <div class="add-more" v-show="item.packFlag === true">
                <div class="add-up">
                  <span>剩余优惠权值: {{item.discountBalance}}</span>
                  <span>被累计时间: {{item.totalAt}}</span>
                  <span>累计上级时间: {{item.totalRefAt}}</span>
                  <span>奖励时间: {{item.rewardAt}}</span>
  ...
  export default {
    ...
    methods: {
      ...
      getData(pageIndex,pageSize) {
        ...
        this.loadShow = true
        this.$fetch.post('/trade/balanceTotal/queryBalanceTotalList', {
          id: this.userId,
