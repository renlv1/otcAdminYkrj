...
<!--          图片上传-->
          ...
          <div class="g-dialog-btn-wrap">
            <button class="g-dialog-btn g-dialog-ok" @click="backupFn" v-show="refStateId === 0 && idArr.length < 2">问题已处理</button>
	    ...
	    backupFn () {
          ...
          type: 'config',
			    okFn: () => {
				    ...
				    this.$fetch.post('/system/feedBack/updateStatus', {
				    	id: this.tabId
            }).then(res => {
